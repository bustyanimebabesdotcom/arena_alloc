...
# Install paths
PREFIX		?= /usr/local
INCLUDEDIR	= $(PREFIX)/include/arena_alloc
...
# Files
SRC		= $(SRCDIR)/arena_alloc.c
OBJ		= $(OBJDIR)/arena_alloc.o
LIB		= $(LIBDIR)/libarena_alloc.a
HEADER	= $(INCDIR)/arena_alloc/arena_alloc.h
